...
class Controller {
  ...
  static async createProduct(req, res, next) {
    ...
    try {
      const { name, description, price, mainImg, UserMongoId, categoryId, imgUrl1, imgUrl2, imgUrl3, imgUrl4, imgUrl5 } = req.body;
  ...
  static async updateProduct(req, res, next) {
    const t = await sequelize.transaction();
    try {
      const { name, description, price, mainImg, categoryId, UserMongoId, imgUrl1, imgUrl2, imgUrl3, imgUrl4, imgUrl5 } = req.body;
      const { id } = req.params;
